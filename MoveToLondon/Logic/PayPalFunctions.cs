...
namespace MoveToLondon.Logic
{
    ...
    public class NVPAPICaller
    {
        ...
        public string APIUsername = "zaheer_sagitarius-facilitator_api1.hotmail.com";
        private string APIPassword = "CRXQXDFQEQH8PAWY";
        private string APISignature = "Azsir1kL9.1Uh2RhOhUJNeii4e7qAo2FvBhS.SclqcRJDe3wNXTs1fhN";
        ...
        public bool ShortcutExpressCheckout(string amt, ref string token, ref string retMsg)
        {
            ...
            string returnURL = "https://localhost:44300/Home/TransactionReview";
            string cancelURL = "https://localhost:44300/Home/TransactionError";
            ...
            //{
            encoder["L_PAYMENTREQUEST_0_NAME"] = "House no. 651";//string.Empty; //myOrderList[i].Product.ProductName.ToString();
            encoder["L_PAYMENTREQUEST_0_AMT"] = amt; //myOrderList[i].Product.UnitPrice.ToString();
            encoder["L_PAYMENTREQUEST_0_QTY"] = "1";//myOrderList[i].Quantity.ToString();
